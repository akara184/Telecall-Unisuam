...
<head>
    ...
    <link rel="stylesheet" href="../../views/internet/internet.css" />
...
<body>
    ...
    <section class="hero is-fullheight">
        <img src="../../images/banner-Internet.png" alt="">
    </section>
    <!--PRIMEIRA SECTION-->
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-image has-text-centered px-4">
                                <img src="../../images/antena.png" alt="">
                                <p class="title is-4 blue">INTERNET DEDICADA</p>
                            </div>
                            <hr>
                            <p class="subtitle is-size-6 blue"> <span class="red">Internet dedicada</span> com o máximo
                                de
                                <span class="red">qualidade</span>, <span class="red">disponibilidade</span> e <span
                                    class="red">segurança</span>.
                        </div>
                        <footer class="card-footer">
                            <p class="card-footer-item">
                                <a href="internet-dedicada/internet-dedicada.php">
                    ...
                    <div class="card disabled">
                        <div class="card-content">
                            <div class="card-image has-text-centered px-4">
                                ...
                                <p class="title is-4 blue">BANDA LARGA</p>
                            </div>
                            <hr>
                            <p class="subtitle is-size-6 blue"><span class="red">Internet em fibra ótica</span> de alta
                                <span class="red">qualidade</span> e <span class="red">velocidade</span>.
                            </p>
                        </div>
                    ...
                    <div class="card disabled">
                        <div class="card-content">
                            <div class="card-image has-text-centered px-4">
                                ...
                                <p class="title is-4 blue">WI-FI</p>

                            </div>
                            <hr>
                            <p class="subtitle is-size-6 blue">
                                <span class="red">Internet sem fio</span> de alta <span class="red">qualidade</span> e
                                <span class="red">velocidade</span>.
                            </p>
                        </div>
                        <footer class="card-footer">
                            <p class="card-footer-item">
                                <a href="wi-fi/wi-fi.php"> <button class="button aProduct">Saiba mais</button></a>
                            </p>
                        </footer>
                    </div>
                </div>
