...
<head>
    ...
    <link rel="stylesheet" href="../../views/rede-e-infa/infra.css" />
...
<body>
    ...
    <section class="hero is-fullheight">
        <img src="../../images/banner-infra.png" alt="">
    </section>
            ...
            <div class="column is-4-tablet is-3-desktop">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-image has-text-centered px-4">
                                ...
                                <p class="title is-4 blue">Ponto-a-Ponto</p>
                            </div>
                            <hr>
                        ...
                        <footer class="card-footer">
                            <p class="card-footer-item">
                                <a href="../../views/rede-e-infa/ponto-a-ponto/ponto-a-ponto.php">
                ...
                <div class="column is-4-tablet is-3-desktop">
                    <div class="card disabled">
                        <div class="card-content">
                            <div class="card-image has-text-centered px-4">
                                <img src="../../images/computacao-em-nuvem.png" alt="">
                ...
                <div class="column is-4-tablet is-3-desktop">
                    <div class="card disabled">
                        <div class="card-content">
                            <div class="card-image has-text-centered px-4">
                                <img src="../../images/fibra-otica.png" alt="">
