...
<head>
    ...
    <link rel=" stylesheet" href="../../views/mobilidade/mobilidade.css" />
...
<body>
    ...
    <section class="hero is-fullheight">
        <img src="../../images/mobilidadeMenu.png" alt="">
    </section>
        ...
        <div class="columns mt-5 is-8 is-variable is-centered">
                ...
                <div class="card">
                    ...
                    <footer class="card-footer">
                        <p class="card-footer-item">
                            <a href="../../views/mobilidade/celular-emp/celular-emp.php">
            ...
            <div class="column is-4-tablet is-3-desktop">
                <div class="card disabled">
                    <div class="card-content">
                        <div class="card-image has-text-centered px-4">
                            <img src="../../images/sim-de-telefone.png" alt="">
